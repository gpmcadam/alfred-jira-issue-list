...
export default USE_ENTERPRISE_SSL.toString() === '1'
  ? {
      https: {
        certificateAuthority: fs.existsSync(CA_PATH) && fs.readFileSync(CA_PATH),
        certificate: fs.existsSync(CERT_PATH) && fs.readFileSync(CERT_PATH),
